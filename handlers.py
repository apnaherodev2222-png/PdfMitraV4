...
async def finish_images_callback(q,context,user_id):
    ...
    try:
        ...
        msg_id=rich_message_id(msg)
        if msg_id: msg.message_id=msg_id
...
async def menu_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # FIX_PM_51: Generate Questions rich feature-entry card with plain PTB fallback.
        ...
        _safe_clear_user_data(context); context.user_data["parent_section"]="create"; context.user_data["action"]="text"; context.user_data["task_prompt_message_id"]=q.message.message_id
        _markup=task_progress_keyboard("text_done","create")
        ...
        if not RICH_AVAILABLE: await _create_fallback()
        else:
            ...
            await rich_replace_or(q.message.chat_id,q.message.message_id,_blocks,_create_fallback)
    elif data == "images":
        # FIX_PM_77: Images → PDF workflow entry rich-first with plain PTB fallback.
        _safe_clear_user_data(context); context.user_data["parent_section"]="create"; context.user_data["action"]="images"; context.user_data["images"]=[]; context.user_data["task_prompt_message_id"]=q.message.message_id
        ...
        if not RICH_AVAILABLE: await _images_fallback()
        else:
            ...
            await rich_replace_or(q.message.chat_id,q.message.message_id,_blocks,_images_fallback)
    elif data == "merge":
        # FIX_PM_77: Merge PDFs workflow entry rich-first with plain PTB fallback.
        _safe_clear_user_data(context); context.user_data["parent_section"]="create"; context.user_data["action"]="merge"; context.user_data["pdfs"]=[]; context.user_data["task_prompt_message_id"]=q.message.message_id
        ...
        if not RICH_AVAILABLE: await _merge_fallback()
        else:
            ...
            await rich_replace_or(q.message.chat_id,q.message.message_id,_blocks,_merge_fallback)
    elif data == "extract":
