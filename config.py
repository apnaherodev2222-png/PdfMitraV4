...
# FIX_PM_9: rich_message.py reads BOT_TOKEN at import time. Mirror the
# primary TOKEN into it so rich sends work without duplicating .env.
os.environ.setdefault("BOT_TOKEN", TOKEN)
_OWNER_ID_RAW = os.getenv("OWNER_ID", "").strip()
try:
    OWNER_ID = int(_OWNER_ID_RAW) if _OWNER_ID_RAW else 0
except ValueError as exc:
    raise RuntimeError("OWNER_ID must be a numeric Telegram user ID in .env") from exc
OWNER_LABEL = "👑 Bot by - @Xalonexdev03"
...
# FIX_PM_2: The previous Gemini model slug was invalid and caused 404 responses,
# including /setaikey auto-detect. Using a real current model.
# FIX_PM_22: preferred current stable Gemini model; 2.0 Flash was shut down in 2026.
GEMINI_MODEL = "gemini-2.5-flash"
MISTRAL_MODEL = "mistral-small-latest"
# FIX_PM_3: The previous OpenRouter model slug was invalid and caused 404 responses.
# always 404s. Using a valid free-tier model.
OPENROUTER_MODEL = "meta-llama/llama-3.3-70b-instruct:free"
AI_PROVIDERS = {"gemini":"Gemini", "mistral":"Mistral AI", "openrouter":"OpenRouter"}
...
# FIX_PM_20: Render/Wispbyte/Heroku inject PORT via env.
